...
Arlo 是一个本地优先的 Windows 桌面数字资产管理工具，当前主要服务于 Skyrim Mod 的整理与浏览。真实文件系统是唯一的事实来源，数据库仅作为元数据增强层（标签、备注、来源 URL、封面关联等）。旧项目名仅作为历史记录说明保留。

> **开发状态**：当前为开发版本（[CHANGELOG.md](CHANGELOG.md) 最新 v0.52.3），工作分支和发布状态以 Git 与 CHANGELOG 为准，尚未发布正式版。
